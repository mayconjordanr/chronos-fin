...
// CHRONOS Fin API Routes for WhatsApp Integration
Route::group(
    [
    ...
    static function (): void {
        ...
        Route::post('whatsapp', ['uses' => 'ChronosController@processWhatsAppMessage', 'as' => 'whatsapp']);
        Route::get('summary/{userId}', ['uses' => 'ChronosController@getFinancialSummary', 'as' => 'summary']);
        Route::get('health', ['uses' => 'ChronosController@healthCheck', 'as' => 'health']);
    }
);

// Public CHRONOS endpoints (no auth required for webhooks)
Route::group(
    [
        'namespace' => 'FireflyIII\Http\Controllers\Api',
        'prefix'    => 'v1/chronos/public',
        'as'        => 'api.v1.chronos.public.'
    ],
    static function (): void {
        Route::get('health', ['uses' => 'ChronosController@healthCheck', 'as' => 'health']);
        Route::post('webhook/whatsapp', ['uses' => 'ChronosController@processWhatsAppMessage', 'as' => 'webhook.whatsapp']);
    }
);
